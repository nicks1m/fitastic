...
public class RecyclerViewAdapterIngredient extends RecyclerView.Adapter<RecyclerViewAdapterIngredient.MyViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.fitastic.diet.RecyclerViewAdapterIngredient.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        view = mInflater.inflate(R.layout.cardview_item_ingredient, parent, false);
        return new com.example.fitastic.diet.RecyclerViewAdapterIngredient.MyViewHolder(view);
    }
